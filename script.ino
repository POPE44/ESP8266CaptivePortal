...
// User configuration
#define SSID_NAME "Hackathon Free WiFi"
#define SUBTITLE "Imagine Connecting"
#define TITLE "Not a Fake Sign in:"
#define BODY "1.) You're an idiot.</br></br>2.) Why would you connect to a free internet source. Thats not very cyber safe of you (especially at a hackathon like for real?)</br></br>3.) Go to 172.0.0.1/creds to see everything inputted in the bars below. Its literally that easy to phish. (Not that id ever do that because it illegal ofc)</br></br>4.) Enter anything below it shouldnt matter</br></br>5.) YOU ARE TOTAALLY SAFE THERES NOTHING MALICIOUS IN THIS SCRIPT (i'm not kidding you are perfectly safe connecting to this dns server XD)<br/>This site is perfectly safe and no harm will come upon connecting (Its literally a HTML page lol)"
#define POST_TITLE "Fake time period where I 'check' if your credentials are valid..."
#define POST_BODY "Your account is being validated. Please, wait up to 5 minutes for device connection.</br>Thank you."
#define PASS_TITLE "The page where you can see how dumb everyone is and how easy it would be to gain credentials"
#define CLEAR_TITLE "You have been 'Cleared' to proceed funny that"
